<section class="relative overflow-hidden">
    <div class="absolute inset-0">
        <div class="absolute -left-24 top-10 h-72 w-72 rounded-full bg-[#ff0033]/10 blur-3xl"></div>
        <div class="absolute right-0 top-0 h-80 w-80 rounded-full bg-[#ffb347]/20 blur-3xl"></div>
    </div>
    <div class="mx-auto w-[92vw] max-w-[1100px] lg:w-[68vw] py-16 lg:py-24 relative">
        <div class="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
            <div class="space-y-6 animate-rise">
                <span class="inline-flex items-center gap-2 rounded-full border border-[#ff0033]/30 bg-white/80 px-4 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-[#ff0033]">YouTube creator network</span>
                <h1 class="font-display text-4xl sm:text-5xl lg:text-[3.6rem] leading-tight text-slate-900">
                    Build YouTube partnerships that feel premium and convert.
                </h1>
                <p class="text-base text-slate-600 max-w-xl">
                    BenTech crafts authentic integrations, clear deliverables, and a frictionless booking flow. Designed for brands that care about impact and trust.
                </p>
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="/packages/" class="rounded-full border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-700 hover:border-slate-400">Browse packages</a>
                </div>
            ...
            <div class="bg-white rounded-3xl shadow-[0_25px_60px_rgba(15,23,42,0.14)] p-6 animate-rise delay-1">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs uppercase tracking-[0.2em] text-slate-400">Popular picks</p>
                        <h3 class="font-display text-lg text-slate-900">Fastest to launch</h3>
                    </div>
